      ...
      >
        ...
        <div className="flex flex-col space-y-4 container mt-16 md:mt-0 ml-0 md:ml-6 lg:ml-10">
          ...
          <div id="text" className="">
            ...
            <p className="text-gray-600 mt-5 xl:mt-10 text-sm xl:text-lg font-Poppins leading-6 lg:leading-8">
            ...
            <p className="text-gray-600 mt-3 xl:mt-10 text-sm xl:text-lg font-Poppins leading-6 lg:leading-8">
