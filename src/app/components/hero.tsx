      ...
      <div className="mx-auto max-w-7xl w-full h-96 py-12 md:py-32">
        <div className="absolute z-50  gap-8 px-8 max-w-7xl mx-auto flex flex-col">
          ...
          <h1 className="text-white text-6xl max-w-2xl font-bold">
            Innovatsion en verre pour le monde entier
          </h1>
          <h2 className="text-white text-lg mt-4 max-w-2xl">
            Valorisant les Marchés du Verre à l&quot;Échelle Mondiale :
            Méditerranée Float Glass propose des solutions verrières de qualité
            à l&quot;échelle mondiale. Du clair au revêtu, du feuilleté à
            l&quot;isolation.
          </h2>
          <div className="mt-10">
