    ...
    >
      ...
      <div className="flex flex-col space-y-4  container ">
        <div className="mt-10 flex justify-center md:justify-start items-end gap-3 text-secondary">
          ...
          <h2 className="uppercase  font-bold">À propos de nous</h2>
        </div>
        <div id="text" className="">
          <h3 className="text-left font-bold text-3xl max-w-sm">
            Élever les innovations en matière de verre à l&quot;échelle
            mondiale 
          </h3>
          <p className="text-gray-600 mt-3">
            Chez Mediterranean Float Glass (MFG), nous nous sommes imposés comme
            un leader dans l&quot;industrie du verre, offrant une gamme étendue
            et diversifiée de produits en verre de haute qualité. Avec un
            engagement inébranlable envers l&quot;excellence, nous nous
            engageons à répondre aux demandes des marchés nationaux et
            internationaux.
          </p>
        </div>
        ...
        <div className="mx-2 py-6">
          <button className="group relative bg-secondary hover:bg-[#0e7ceb] py-3 px-6 text-white outline-none  focus:bg-secondary">
            <span
              ...
              aria-hidden="true"
            ></span>
            <span className="uppercase font-bold">Lire Plus</span>
            <span
