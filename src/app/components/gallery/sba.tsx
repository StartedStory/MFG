  ...
  return (
    <div>
      ...
      <div
        ...
        onClick={() =>
          openModal(
            "/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8367.webp"
          )
        }
      >
        <Image
...
{/* 
      <div
        ...
        onClick={() =>
          openModal(
            "/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8369.webp"
          )
        }
      >
        <Image
      ...
      <div
        ...
        onClick={() =>
          openModal(
            "/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8372.webp"
          )
        }
      >
        <Image
          ...
          height={500}
          className="w-full"
          src={"/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8372.webp"}
        ></Image>
      </div>
      ...
      <div
        ...
        onClick={() =>
          openModal(
            "/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8373.webp"
          )
        }
      >
        <Image
          ...
          height={500}
          className="w-full"
          src={"/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8373.webp"}
        ></Image>
      </div>
      ...
      <div
        ...
        onClick={() =>
          openModal(
            "/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8375.webp"
          )
        }
      >
        <Image
          ...
          height={500}
          className="w-full"
          src={"/assets/img/WebP Project Photos MFG/SBA HASNAOUI/IMG_8375.webp"}
        ></Image>
      </div>
