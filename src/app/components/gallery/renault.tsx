  ...
  return (
    <div>
      <div
        ...
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8407.webp")
        }
      >
        <Image
          alt="random"
      ...
      <div
        className="w-auto hover:scale-105 cursor-pointer duration-150 relative mb-4 before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-20"
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8428.webp")
        }
      >
        <Image
          alt="random"
      ...
      <div
        className="w-auto hover:scale-105 cursor-pointer duration-150 relative mb-4 before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-20"
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8429.webp")
        }
      >
        <Image
          alt="random"
      ...
      <div
        className="w-auto hover:scale-105 cursor-pointer duration-150 relative mb-4 before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-20"
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8430.webp")
        }
      >
        <Image
          alt="random"
      ...
      <div
        className="w-auto hover:scale-105 cursor-pointer duration-150 relative mb-4 before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-20"
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8431.webp")
        }
      >
        <Image
          alt="random"
      ...
      <div
        className="w-auto hover:scale-105 cursor-pointer duration-150 relative mb-4 before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-20"
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8432.webp")
        }
      >
        <Image
          alt="random"
      ...
      <div
        className="w-auto hover:scale-105 cursor-pointer duration-150 relative mb-4 before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-20"
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8434.webp")
        }
      >
        <Image
          alt="random"
      ...
      <div
        className="w-auto hover:scale-105 cursor-pointer duration-150 relative mb-4 before:content-[''] before:absolute before:inset-0 before:bg-black before:bg-opacity-20"
        onClick={() =>
          openModal("/assets/img/WebP Project Photos MFG/Renault/IMG_8462.webp")
        }
      >
        <Image
          alt="random"
