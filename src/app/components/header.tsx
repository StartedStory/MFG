...
export default function Header() {
  return (
    ...
    <div className="flex flex-col bg-primary ">
      <div
        id="top-bar"
        className=" h-auto justify-center xl:ml-56  w-full flex flex-row  lg:px-32 text-white  p-2 "
      >
        <div className="inline-flex items-center lg:pr-8">
          <a className="hover:text-secondary hover:cursor-pointer" href="tel:+21321448644">
            <i className="fa-solid fa-phone"></i> +213 21 448 644
          </a>
        </div>
        <div className="inline-flex items-center border-l border-secondary px-8">
          <a  className="hover:text-secondary hover:cursor-pointer" href="mailto:contact@mfg.dz">
  ...
  >
    <div className="flex items-center justify-between w-full">
      ...
      <ul className="lg:flex gap-8 xl:gap-12 font-semibold hidden">
        <li className="hover:text-secondary hover:cursor-pointer">Accueil</li>
        <li className="hover:text-secondary hover:cursor-pointer">Notre Société</li>
        <li className="hover:text-secondary hover:cursor-pointer">Nos Produits</li>
        <li className="hover:text-secondary hover:cursor-pointer">Actualités</li>
        <li className="hover:text-secondary hover:cursor-pointer">Outils et téléchargement</li>
        <li className="hover:text-secondary hover:cursor-pointer">Carrière</li>
        <li className="hover:text-secondary hover:cursor-pointer">Contact</li>
      </ul>
    </div>
